...
install.packages('car'); install.packages('broom'); install.packages('networkD3'); install.packages('estimatr'); install.packages('paletteer')
...
library(car); library(broom); library(networkD3); library(estimatr); library(paletteer)
options(scipen = 999)
