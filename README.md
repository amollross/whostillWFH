...
The code can be run directly from the **00_MASTER_RUN_FILE.R**, after editing the three "location/" lines in the file to the relevant locations for outputs and the combined data from HILDA wave 24 (restricted release). The 00_MASTER_RUN_FILE.R does not require downloading the non-HILDA data and other code snippets to run, as it will draw them directly from this repository.
